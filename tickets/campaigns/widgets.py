...
from campaigns.models import IssuedTicket, Campaign, TicketCounter
...
class CoutersWidget(KnobWidget):
    ...
    def get_amount(self):
        return get_tickets_queryset().values('cart__ticket_type__counter__amount', 'cart__ticket_type__counter__id'). \
            distinct().aggregate(Sum('cart__ticket_type__counter__amount'))['cart__ticket_type__counter__amount__sum']
